...
function Home() {
  ...
  return (
    <AllContainer data={data} loading={loading} error={error}>
      <div className="mt-3 bg-transparent h-100 d-flex align-items-center flex-column justify-content-center w-100">
        ...
        <p class="fw-bolder fs-5 select-title">Please select a model</p>
        <p class="fw-bolder space  mt-2 mb-3">---------------</p>
        <Carousel
          autoPlay
          className="w-100"
          keyBoardControl
